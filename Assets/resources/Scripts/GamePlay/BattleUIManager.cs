...
public class BattleUIManager : MonoBehaviour
{
    ...
    void SetupDeckUI()
    {
        ...
        runtimeDeck = new List<UnitData>(sourceDeck); // ✅ shuffled copy
    ...
    public void UseCard(int slotIndex)
    {
        ...
        if (spawner != null)
        {
            ...
            if (KarmaStateTracker.Instance != null)
            {
                ...
                float currentElixir = energySystem != null ? energySystem.currentEnergy : 1f;
                KarmaStateTracker.Instance.OnCardPlayed(isOffensive, currentElixir);
            }
        }
...
UpdateNextCardVisual();
    ...
    void Update()
    {
        if (energySystem != null)
        {
            ...
            if (elixirText)
                elixirText.text =
                    $"{Mathf.FloorToInt(energySystem.currentEnergy)} / {energySystem.maxEnergy}";
        }
    }
